...
class BotBase:
	def __init__(self, bot_name, token, channel_chat_id, service_type, http_session, admin_user_id):
		...
		self.bot_handlers = BotHandlers(self.bot_name, self.bot, self.service_type, self.admin_user_id, self.channel_chat_id)
